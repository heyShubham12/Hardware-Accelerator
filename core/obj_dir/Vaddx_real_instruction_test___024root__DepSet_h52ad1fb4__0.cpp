...
void Vaddx_real_instruction_test___024root___eval_triggers__act(Vaddx_real_instruction_test___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vaddx_real_instruction_test___024root___eval_triggers__act\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VactTriggered.set(0U, (((IData)(vlSelfRef.addx_real_instruction_test__DOT__clk_i) 
                                        & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__addx_real_instruction_test__DOT__clk_i__0))) 
                                       | ((~ (IData)(vlSelfRef.addx_real_instruction_test__DOT__rst_ni)) 
                                          & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__addx_real_instruction_test__DOT__rst_ni__0))));
    vlSelfRef.__VactTriggered.set(1U, ((IData)(vlSelfRef.addx_real_instruction_test__DOT__clk_i) 
                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__addx_real_instruction_test__DOT__clk_i__0))));
